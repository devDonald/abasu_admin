...
import 'package:farmers_market/src/screens/edit_admins.dart';
...
abstract class Routes {
  static MaterialPageRoute materialRoutes(RouteSettings settings) {
    switch (settings.name) {
      case "/landing":
        return MaterialPageRoute(builder: (context) => Admins());
      case "/signup":
      ...
      case "/editvendor":
        return MaterialPageRoute(builder: (context) => EditAdmin());
      default:
  ...
  static CupertinoPageRoute cupertinoRoutes(RouteSettings settings) {
    switch (settings.name) {
      case "/landing":
        return CupertinoPageRoute(builder: (context) => Admins());
      case "/signup":
      ...
      case "/editproduct":
       ...
       case "/editvendor":
        return CupertinoPageRoute(builder: (context) => EditAdmin());
      default:
        var routeArray = settings.name.split('/');
        if (settings.name.contains('/editproduct/')) {
