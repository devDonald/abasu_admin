...
class PlatformApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (Platform.isIOS) {
      return CupertinoApp(
        home: (isLoggedIn == null) ? loadingScreen(true) : (isLoggedIn == true ) ? Admins() : Login(),
      ...
      return MaterialApp(
        home: (isLoggedIn == null) ? loadingScreen(false) : (isLoggedIn == true ) ? Admins() : Login(),
