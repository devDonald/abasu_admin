...
class ProductBloc {
  ...
  Stream<String> get subCategory => _sub_category.stream;
  ...
  Stream<bool> get isValid => CombineLatestStream.combine5(
      productName, category, unitPrice, availableUnits, subCategory, (a, b, c, d, e) => true);
  ...
  Function(String) get changeSubCategory => _sub_category.sink.add;
  ...
  Future<void> saveProduct() async {
    var product = Product(
      ...
      subCategory: _sub_category.value,
      category: _category.value,
      adminId: _vendorId.value,
...
//         if (category != null) {
//           sink.add(category.trim());
//         }
//       });
//   final validateSubCategory = StreamTransformer<String, String>.fromHandlers(
//       handleData: (subCategory, sink) {
//         if (subCategory != null) {
//           sink.add(subCategory.trim());
//         }
//       });
